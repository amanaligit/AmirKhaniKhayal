...
function NewPostModal({ isModalOpen, toggleModal, setPosts }) {
    const schema = yup.object({
        ...
        YTlinks: yup.array().of(
            yup.object({
                link: yup.string().url("Should be a url")
    ...
    return (
        <Modal centered={true} isOpen={isModalOpen} size="lg" toggle={() => toggleModal(t => !t)}>
            ...
            <ModalBody>
                ...
                {loading ?
                    ...
                    <form className="form-group" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <label htmlFor="input1">Upload Images(Optional): </label>
